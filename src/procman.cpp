...
main (int argc, char *argv[])
{
    ...
    conn = bacon_message_connection_new ("gde2-system-monitor");
    if (!conn) g_error("Couldn't connect to gde2-system-monitor");
    ...
    gtk_widget_set_name(procdata->app, "gde2-system-monitor");
